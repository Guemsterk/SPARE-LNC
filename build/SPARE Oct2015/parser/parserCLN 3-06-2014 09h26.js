...
parserCLN = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c111 = function(id) { return id; },
        peg$c112 = /^[0-9]/,
        ...
        peg$c122 = function(id) {return  "'" +id.join("") + "'" ; },
        peg$c123 = /^[^\r\n.,0-9]/,
        peg$c124 = { type: "class", value: "[^\\r\\n.,0-9]", description: "[^\\r\\n.,0-9]" },
        peg$c125 = function(id) {return "'"+id.join("").replace(/^\s+/g,'').replace(/\s+$/g,'')+"'"; },
        peg$c126 = "suivi",
        peg$c127 = { type: "literal", value: "suivi", description: "\"suivi\"" },
        peg$c128 = "par",
        peg$c129 = { type: "literal", value: "par", description: "\"par\"" },
        peg$c130 = function(ob, c2) { 
        condition ="";
        var dependances = [];
        for( w in c2)
        {
        ...
        peg$c131 = "pr\xE9c\xE9d\xE9",
        peg$c132 = { type: "literal", value: "pr\xE9c\xE9d\xE9", description: "\"pr\\xE9c\\xE9d\\xE9\"" },
        peg$c133 = function(ob, c2) { 
        condition ="";
        var dependances = [];
        for( w in c2)
        {
        ...
        peg$c134 = "strictement",
        peg$c135 = { type: "literal", value: "strictement", description: "\"strictement\"" },
        peg$c136 = function(ob, c2) { 
        condition ="";
        var dependances = [];
        for( w in c2)
        {
        ...
        return [" successor("+ob+","+"?sobs"+id_obj+") \n" + condition, null ];},
        peg$c140 = "pendant",
        peg$c141 = { type: "literal", value: "pendant", description: "\"pendant\"" },
        peg$c142 = function(ob, c2) { 
        condition ="";
        var dependances = [];
        for( w in c2)
        {
        ...
        peg$c143 = /^[element]/,
        peg$c144 = { type: "class", value: "[element]", description: "[element]" },
        peg$c145 = "lui",
        peg$c146 = { type: "literal", value: "lui", description: "\"lui\"" },
        peg$c147 = "m\xEAme",
        peg$c148 = { type: "literal", value: "m\xEAme", description: "\"m\\xEAme\"" },
        peg$c149 = function(c1) {return c1;},
        peg$c150 = "attributs",
        peg$c151 = { type: "literal", value: "attributs", description: "\"attributs\"" },
        peg$c152 = function(val) { return " { ?sobs"+ id_obj + " ?pobs" + id_obj+" "+ val + " . }";},
        peg$c153 = function(id, val) { return " { ?sobs"+ id_obj + " model:"+id.join("")+ " " + val + " . }";},
        peg$c154 = function(id) {
         if(id.join("") =="") return " { ?sobs"+ id_obj + " ?pobs" + id_obj+" "+ " ?oobs" + id_obj+" . }";
         return "{ ?sobs"+ id_obj +" model:"+id.join("") + " ?oobs" + id_obj +" }"; },
        peg$c155 = function(id) { return " { ?sobs"+ id_obj + " model:"+id.join("")+" ?oobs"+ id_obj+" . }";},
        peg$c156 = /^[.]/,
        ...
        peg$c172 = function(w) { return ":" + w.join("");},
        peg$c173 = "<",
        ...
        peg$c179 = function(id) { return '<' +id.join("")+ '>'; },
        peg$c180 = /^[ ]/,
        peg$c181 = { type: "class", value: "[ ]", description: "[ ]" },
        peg$c182 = function() { return ref},
