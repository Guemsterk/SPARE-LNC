...
parserCLN = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c93 = "ayant",
        peg$c94 = { type: "literal", value: "ayant", description: "\"ayant\"" },
        peg$c95 = "attribut",
        peg$c96 = { type: "literal", value: "attribut", description: "\"attribut\"" },
        peg$c97 = function(id) { 
        cond_push++;
        return "?sobs" + (id_obj+act_requete) +" model:"+id.join("") +" ?oobs"+(id_obj+act_requete)+id.join(""); 
        },
        peg$c98 = "valeur",
        peg$c99 = { type: "literal", value: "valeur", description: "\"valeur\"" },
        peg$c100 = function(id, val) { 
        cond_push++;
        return "FILTER( ?oobs"+(id_obj+act_requete)+id.join("") + " = "+ val +" ) \n" +
        " ?sobs" + (id_obj+act_requete) +" model:"+id.join("") +" ?oobs"+(id_obj+act_requete)+id.join("") ; 
        },
        peg$c101 = "n",
        peg$c102 = { type: "literal", value: "n", description: "\"n\"" },
        peg$c103 = "'",
        peg$c104 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c105 = "pas",
        peg$c106 = { type: "literal", value: "pas", description: "\"pas\"" },
        peg$c107 = function(id, val) { 
        cond_push++;
        ...
        peg$c110 = function(id) { return id; },
        peg$c111 = /^[0-9]/,
        ...
        peg$c121 = function(id) {return  "'" +id.join("") + "'" ; },
        peg$c122 = /^[^\r\n.,0-9]/,
        peg$c123 = { type: "class", value: "[^\\r\\n.,0-9]", description: "[^\\r\\n.,0-9]" },
        peg$c124 = function(id) {return "'"+id.join("").replace(/^\s+/g,'').replace(/\s+$/g,'')+"'"; },
        peg$c125 = "suivi",
        peg$c126 = { type: "literal", value: "suivi", description: "\"suivi\"" },
        peg$c127 = "par",
        peg$c128 = { type: "literal", value: "par", description: "\"par\"" },
        peg$c129 = function(ob, c2) { return " after("+ob+","+"?sobs"+id_obj+") \n" + c2.join("\n") },
        peg$c130 = "pr\xE9c\xE9d\xE9",
        peg$c131 = { type: "literal", value: "pr\xE9c\xE9d\xE9", description: "\"pr\\xE9c\\xE9d\\xE9\"" },
        peg$c132 = function(ob, c2) { return " before("+ob+","+"?sobs"+id_obj+") \n" + c2.join("\n") },
        peg$c133 = "strictement",
        peg$c134 = { type: "literal", value: "strictement", description: "\"strictement\"" },
        peg$c135 = function(ob, c2) { return " predecessor("+ob+","+"?sobs"+id_obj+") \n" + c2.join("\n") },
        peg$c136 = function(ob, c2) { return " successor("+ob+","+"?sobs"+id_obj+") \n" + c2.join("\n") },
        peg$c137 = "pendant",
        peg$c138 = { type: "literal", value: "pendant", description: "\"pendant\"" },
        peg$c139 = function(ob, c2) { return " during("+ob+","+"?sobs"+id_obj+") \n" + c2.join("\n") },
        peg$c140 = /^[element]/,
        peg$c141 = { type: "class", value: "[element]", description: "[element]" },
        peg$c142 = "lui",
        peg$c143 = { type: "literal", value: "lui", description: "\"lui\"" },
        peg$c144 = "m\xEAme",
        peg$c145 = { type: "literal", value: "m\xEAme", description: "\"m\\xEAme\"" },
        peg$c146 = function(c1) {return c1;},
        peg$c147 = "attributs",
        peg$c148 = { type: "literal", value: "attributs", description: "\"attributs\"" },
        peg$c149 = function(id) { return " { ?sobs"+ id_obj + " model:"+id.join("")+" ?oobs"+ id_obj+" . }";},
        peg$c150 = function(id, val) { return " { ?sobs"+ id_obj + " model:"+id.join("")+ " " + val + " . }";},
        ...
        peg$c165 = function(id) { return id;},
        peg$c166 = /^[^ \n\t]/,
        peg$c167 = { type: "class", value: "[^ \\n\\t]", description: "[^ \\n\\t]" },
        peg$c168 = function(w) { return ":" + w.join("");},
        peg$c169 = "<",
        ...
        peg$c175 = function(id) { return '<' +id.join("")+ '>'; },
        peg$c176 = /^[ ]/,
        peg$c177 = { type: "class", value: "[ ]", description: "[ ]" },
        peg$c178 = function() { return ref},
