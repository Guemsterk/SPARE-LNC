...
parserCLN = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c130 = function(ob, c2) { return " after("+ob+","+"?sobs"+id_obj+") \n" + c2.join("\n") },
        peg$c131 = "pr\xE9c\xE9d\xE9",
        peg$c132 = { type: "literal", value: "pr\xE9c\xE9d\xE9", description: "\"pr\\xE9c\\xE9d\\xE9\"" },
        peg$c133 = function(ob, c2) { return " before("+ob+","+"?sobs"+id_obj+") \n" + c2.join("\n") },
        peg$c134 = "strictement",
        peg$c135 = { type: "literal", value: "strictement", description: "\"strictement\"" },
        peg$c136 = function(ob, c2) { return " predecessor("+ob+","+"?sobs"+id_obj+") \n" + c2.join("\n") },
        peg$c137 = function(ob, c2) { return " successor("+ob+","+"?sobs"+id_obj+") \n" + c2.join("\n") },
        peg$c138 = "pendant",
        peg$c139 = { type: "literal", value: "pendant", description: "\"pendant\"" },
        peg$c140 = function(ob, c2) { return " during("+ob+","+"?sobs"+id_obj+") \n" + c2.join("\n") },
        peg$c141 = /^[element]/,
        peg$c142 = { type: "class", value: "[element]", description: "[element]" },
        peg$c143 = "lui",
        peg$c144 = { type: "literal", value: "lui", description: "\"lui\"" },
        peg$c145 = "m\xEAme",
        peg$c146 = { type: "literal", value: "m\xEAme", description: "\"m\\xEAme\"" },
        peg$c147 = function(c1) {return c1;},
        peg$c148 = "attributs",
        peg$c149 = { type: "literal", value: "attributs", description: "\"attributs\"" },
        peg$c150 = function(id) { return " { ?sobs"+ id_obj + " model:"+id.join("")+" ?oobs"+ id_obj+" . }";},
        peg$c151 = function(id, val) { return " { ?sobs"+ id_obj + " model:"+id.join("")+ " " + val + " . }";},
        ...
        peg$c166 = function(id) { return id;},
        peg$c167 = /^[^ \n\t]/,
        peg$c168 = { type: "class", value: "[^ \\n\\t]", description: "[^ \\n\\t]" },
        peg$c169 = function(w) { return ":" + w.join("");},
        peg$c170 = "<",
