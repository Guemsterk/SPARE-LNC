  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        */
        ...
        peg$c102 = function(id) { return " rdf:type model:"+id.join(""); },
        peg$c103 = "n",
        ...
        cond_push++;
        return "?sobs" + (id_obj+act_requete) +check_model( id.join("") ) +" ?oobs"+(id_obj+act_requete)+id.join(""); 
        },
        peg$c115 = "valeur",
        ...
        peg$c147 = function(id) { return id; },
        peg$c148 = function(date) { return date;},
        ...
        peg$c160 = function(id) {return "'"+id.join("").replace(/^\s+/g,'').replace(/\s+$/g,'')+"'"; },
        peg$c161 = "suivi",
        peg$c162 = { type: "literal", value: "suivi", description: "\"suivi\"" },
        peg$c163 = "par",
        peg$c164 = { type: "literal", value: "par", description: "\"par\"" },
        ...
        peg$c166 = "pr\xE9c\xE9d\xE9",
        peg$c167 = { type: "literal", value: "pr\xE9c\xE9d\xE9", description: "\"pr\\xE9c\\xE9d\\xE9\"" },
        ...
        peg$c169 = "strictement",
        peg$c170 = { type: "literal", value: "strictement", description: "\"strictement\"" },
        peg$c171 = function(ob, c2) { 
        condition ="";
        var dependances = [];
        for( w in c2)
        {
        ...
        return [" successor("+ob+","+"?sobs"+id_obj+") \n" + condition, null ];},
        peg$c175 = "pendant",
        peg$c176 = { type: "literal", value: "pendant", description: "\"pendant\"" },
        ...
        peg$c178 = /^[element]/,
        peg$c179 = { type: "class", value: "[element]", description: "[element]" },
        peg$c180 = "lui",
        peg$c181 = { type: "literal", value: "lui", description: "\"lui\"" },
        peg$c182 = "m\xEAme",
        peg$c183 = { type: "literal", value: "m\xEAme", description: "\"m\\xEAme\"" },
        peg$c184 = function(c1) {return c1;},
        peg$c185 = "attributs",
        peg$c186 = { type: "literal", value: "attributs", description: "\"attributs\"" },
        peg$c187 = function(id, val) { return " { ?sobs"+ id_obj + check_model( id.join("") )+ " " + val + " . }";},
        peg$c188 = function(id) { return "{ ?sobs"+ id_obj +check_model( id.join("") ) + " ?oobs" + id_obj +" }"; },
        peg$c189 = function(id) { return " { ?sobs"+ id_obj + check_model( id.join("") )+" ?oobs"+ id_obj+" . }";},
        peg$c190 = /^[.]/,
        ...
        peg$c208 = function(w) { return ":" + w.join("");},
        peg$c209 = "+",
        peg$c210 = { type: "literal", value: "+", description: "\"+\"" },
        peg$c211 = function(left, right) { return [ "" + left[0] + "+" + right[0],  my_parser_fusion(left[1], right[1]) ]; },
        peg$c212 = "-",
        peg$c213 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c214 = function(left, right) { return [ "" + left[0] + "-" + right[0], my_parser_fusion(left[1], right[1]) ]; },
        peg$c215 = "*",
        peg$c216 = { type: "literal", value: "*", description: "\"*\"" },
        peg$c217 = function(left, right) { return [ "" + left[0] + "*" + right[0], my_parser_fusion(left[1], right[1]) ]; },
        peg$c218 = "/",
        peg$c219 = { type: "literal", value: "/", description: "\"/\"" },
        peg$c220 = function(left, right) { return [ "" + left[0] + "/" + right[0], my_parser_fusion(left[1], right[1]) ]; },
        peg$c221 = function(prim) { return prim; },
        peg$c222 = "(",
        peg$c223 = { type: "literal", value: "(", description: "\"(\"" },
        peg$c224 = ")",
        peg$c225 = { type: "literal", value: ")", description: "\")\"" },
        peg$c226 = function(additive) { return [ "" + "(" + additive[0] + ")", additive[1] ]; },
        peg$c227 = "count",
        peg$c228 = { type: "literal", value: "COUNT", description: "\"COUNT\"" },
        peg$c229 = function(p) { return [ "count" + "(" + p[0] + ")", p[1] ]; },
        peg$c230 = "sum",
        peg$c231 = { type: "literal", value: "SUM", description: "\"SUM\"" },
        peg$c232 = "min",
        peg$c233 = { type: "literal", value: "MIN", description: "\"MIN\"" },
        peg$c234 = "max",
        peg$c235 = { type: "literal", value: "MAX", description: "\"MAX\"" },
        peg$c236 = "avg",
        peg$c237 = { type: "literal", value: "AVG", description: "\"AVG\"" },
        peg$c238 = { type: "other", description: "integer" },
        peg$c239 = function(digits) { return [ parseInt(digits.join(""), 10) , null]; },
        peg$c240 = { type: "other", description: "float" },
        peg$c241 = ".",
        peg$c242 = { type: "literal", value: ".", description: "\".\"" },
        peg$c243 = function(digits, digitsvirgule) { return [ ""+digits.join("") +"." + digitsvirgule.join("")  , null]; },
        peg$c244 = { type: "other", description: "special_variable" },
        peg$c245 = function(ref) { 
        			//alert("Nomination ! : ref : " + ref);
        			return [ "id_ref"+ref+"_eq", [ [ref, 1] ] ];
        		},
        peg$c246 = /^[a-zA-Z]/,
        peg$c247 = { type: "class", value: "[a-zA-Z]", description: "[a-zA-Z]" },
        peg$c248 = /^[^ .,\\\r\n\t\\)\\(\\+\\-\\*\\\/]/,
        peg$c249 = { type: "class", value: "[^ .,\\\\\\r\\n\\t\\\\)\\\\(\\\\+\\\\-\\\\*\\\\\\/]", description: "[^ .,\\\\\\r\\n\\t\\\\)\\\\(\\\\+\\\\-\\\\*\\\\\\/]" },
        peg$c250 = function(id1, id) { return "" + id1 + id.join(""); },
        peg$c251 = "<",
        ...
        peg$c260 = function() { return ref},
        peg$c261 = /^[0-2]/,
        peg$c262 = { type: "class", value: "[0-2]", description: "[0-2]" },
        peg$c263 = /^[3]/,
        peg$c264 = { type: "class", value: "[3]", description: "[3]" },
        peg$c265 = /^[0-1]/,
        peg$c266 = { type: "class", value: "[0-1]", description: "[0-1]" },
        peg$c267 = ":",
        peg$c268 = { type: "literal", value: ":", description: "\":\"" },
        peg$c269 = /^[1]/,
        peg$c270 = { type: "class", value: "[1]", description: "[1]" },
        peg$c271 = /^[02]/,
        peg$c272 = { type: "class", value: "[02]", description: "[02]" },
        peg$c273 = /^[13578]/,
        peg$c274 = { type: "class", value: "[13578]", description: "[13578]" },
        peg$c275 = function(day, month, year, h) {
        ...
        peg$c276 = /^[0]/,
        peg$c277 = { type: "class", value: "[0]", description: "[0]" },
        peg$c278 = /^[469]/,
        peg$c279 = { type: "class", value: "[469]", description: "[469]" },
        peg$c280 = function(day, month, year, h) { 
        var newDate=[].concat(month).join("")+","+[].concat(day).join("") +","+year.join(""); 
        var date_and_hours = new Date(newDate);
        if(h!=null){ date_and_hours = new Date( date_and_hours.getTime() + (h[0]*60 + h[1])*60000 + h[2]*1000 )}
        return date_and_hours.getTime();
        ...
        peg$c283 = /^[0-5]/,
        peg$c284 = { type: "class", value: "[0-5]", description: "[0-5]" },
        peg$c285 = "h",
        peg$c286 = { type: "literal", value: "h", description: "\"h\"" },
        peg$c287 = "m",
        peg$c288 = { type: "literal", value: "m", description: "\"m\"" },
        peg$c289 = "s",
        peg$c290 = { type: "literal", value: "s", description: "\"s\"" },
        peg$c291 = function(hour, min, sec) {
            var seconde = 0;
     ...
     // id_req est utilisé pour faire l'id de la requete (qui est une chaine de caractères)
      ...
      {	
    		...
    		for( bk=0; bk<request_list[num][3].length; bk++)
    		{
    			...
    			temp_rep = replaced_string1+'_eq';
    			request_list[num][2] = request_list[num][2].replace( temp_rep, equation_remp+remplace_id);
    			
    			// On a tout trouvé, on fait tout les remplacements possibles
    			temp_rep = replaced_string1+'_s';
    			request_list[num][2] = request_list[num][2].replace( temp_rep, "?sobs"+remplace_id);
    			temp_rep = replaced_string1+'_p';
    			request_list[num][2] = request_list[num][2].replace( temp_rep, "?pobs"+remplace_id);
    			temp_rep = replaced_string1+'_o';
    			request_list[num][2] = request_list[num][2].replace( temp_rep, "?oobs"+remplace_id);
    			temp_rep = 'num_'+replaced_string1;
    			request_list[num][2] = request_list[num][2].replace( temp_rep, "?num_sobs"+remplace_id);
      ...
      /*====================================*/
       function my_parser_select_some( select_list, request_list)
      {	
    		new_chaine = "";
    		to_find = null ;
    		request_dependance = null;
